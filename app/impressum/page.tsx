...
export const metadata: Metadata = {
  title: "Impressum | PlayViennaGames",
  description: "Rechtliche Informationen und Kontaktdaten des Websitebetreibers.",
}
    ...
    <div className="container py-12">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          ...
          <br />
          Website: www.playviennagames.com
        </p>
        ...
        <p>Magistratisches Bezirksamt für den 6. Bezirk, Wien</p>

        <h2>Berufsrechtliche Angaben</h2>
        <p>
          Gewerbeordnung: www.ris.bka.gv.at
          <br />
          Gewerbeberechtigung: Handel mit Spielwaren und Freizeitartikeln
        </p>
